...
- [x] Hub's input resolution and split-point coordinates — confirmed 2026-09-16 on real hardware: 1920x1080, even split lines up with the physical bezels exactly across all five presets (1x1, 1x2, 2x1, 2x2, 2x3)
- [x] Whether the hub does bezel compensation — confirmed 2026-09-16: not needed
